...
<body class="bg-gradient-to-r from-cyan-500 to-blue-500 flex justify-center mt-52 overflow-hidden">
    <div class="absolute bottom-[-50px]">
        <svg width="2500" height="729" viewBox="0 0 1440 420" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="w-[500px] h-[550x] md:w-[550px] flex justify-center bg-red-500 p-5 bg-gray-500 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-400">
        <div>
